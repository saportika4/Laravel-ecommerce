...
<body>
    ...
    <div class="text-center">
        ...
        <p>
            Thank you for purchasing with {{ $appSetting->website_name ?? ' laravel ecommerce' }}
        </p>
    </div>
        ...
        <tbody>
            ...
            @foreach ($order->orderItems as $orderItem)
                <tr>
                    ...
                    <td width="15%" style="font-weight: bold;">${{ $orderItem->quantity * $orderItem->price }}</td>
            ...
            @endforeach
                <tr>
                    <td colspan="4" style="font-weight: bold; text-align:right;">Total Amount: - <small>Inc. all vat/tax</small> :</td>
